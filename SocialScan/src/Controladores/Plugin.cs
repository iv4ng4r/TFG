...
namespace FocaPlugin
{
    public class Plugin
    {
        private string _name = "Social Scan";
        private string _description = "Social Network Account Scanning Tool";
        private PluginForm main = new PluginForm();
        
        public static PluginForm mainForm;
        ...
        public Plugin()
        {
            if (Plugin.mainForm == null)
                Plugin.mainForm = new PluginForm();
